...
export function ClassicTemplate({ data }: TemplateProps) {
  return (
    <div className="classic-template" style={{ width: '100%', color: '#000', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      {/* Header */}
      <div className="section header-section">
        <div className="text-center space-y-2 mb-6">
          <h1 className="text-3xl font-bold text-gray-900">{data.header.name || 'Your Name'}</h1>
      ...
      {data.changesSummary && (
        <div className="section">
          <h2 className="text-xl font-semibold mb-4 text-gray-900">Changes Summary</h2>
