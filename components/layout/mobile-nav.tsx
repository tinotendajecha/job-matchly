    ...
    <>
      ...
      {open && (
        <div className="lg:hidden fixed inset-0 z-50">
          ...
          <div className="absolute inset-y-0 left-0 w-[82%] max-w-xs bg-card border-r border-border shadow-xl flex flex-col animate-in slide-in-from-left duration-200">
